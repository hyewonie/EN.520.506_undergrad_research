...
# Add the parent directory of `code` to the system path
sys.path.append('research/code')
...
def train():
    log_file = open('training_result.txt', 'a') # for outputting the training results to txt file
    ...
    for key, val in max_val.items():
        ...
        log_file.write(f'{key.replace("_", " ")} : {val}\n')
...
if __name__ == '__main__':
    ...
    adj, features, labels, idx_train, idx_val, idx_test = load_data_medical(dataset_addr='./shortest_followup_raw.pkl',
